    ...
    >
      <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
        ...
        >
          <a
            href="./about-lan.tsx"
            className="block mt-4 md:inline-block md:mt-0 md:mr-4 hover:text-orange-500 transition-all duration-300 ease-in-out"
          >
            Developer
          </a>
          <a className="block mt-4 md:inline-block md:mt-0 md:mr-4 hover:text-orange-500 transition-all duration-300 ease-in-out">
            Products
          </a>
          <a className="block mt-4 md:inline-block md:mt-0 md:mr-4 hover:text-orange-500 transition-all duration-300 ease-in-out">
            Pricing
          ...
          <a className="block mt-4 md:inline-block md:mt-0 hover:text-orange-500 transition-all duration-300 ease-in-out">
            Contact
          </a>
        </nav>
